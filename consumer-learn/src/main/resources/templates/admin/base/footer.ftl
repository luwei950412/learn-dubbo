...
<div id="ascrail2000-hr" class="nicescroll-rails"
     style="height: 5px; z-index: 222; top: 626px; left: 0px; position: fixed; cursor: default; width: 225px; opacity: 0; display: block;">
    <div style="position: relative; top: 0px; height: 5px; width: 207px; background-color: rgb(33, 150, 243); border: 1px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 5px; left: 0px;"></div>
</div>
<div id="ascrail2001" class="nicescroll-rails"
     style="width: 24px; z-index: -1; cursor: -moz-grab; position: absolute; top: 0px; left: 76px; height: 300px; display: none;">
...
<div id="ascrail2001-hr" class="nicescroll-rails"
     style="height: 24px; z-index: -1; top: 276px; left: 0px; position: absolute; display: none;">
...
<script type="text/javascript">
    (function (jQuery) {
            ...
            if (undefined !== tooltip.labels && tooltip.labels.length) {
                for (var i = tooltip.labels.length - 1; i >= 0; i--) {
                    innerHtml += [
                        ...
                        style = "background-color:' + tooltip.legendColors[i].fill + '" > < /span>',
        ...
        window.onload = function () {
            ...
            Chart(ctx).Doughnut(doughnutData, {
                responsive: true,
                showTooltips: true
            });
            ...
            window.myDoughnut2 = new
            Chart(ctx4).Doughnut(doughnutData2, {
                responsive: true,
                showTooltips: true
            });
