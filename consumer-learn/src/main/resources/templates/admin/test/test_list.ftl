                    ...
                    <div class="responsive-table">
                        <div id="datatables-example_wrapper"
                            ...
                            <div class="row">
                                    ...
                                    <div id="datatables-example_filter" class="dataTables_filter">
                                        ...
                                        <script>
                                            function choiceCourse(){
                                                ...
                                                window.location.href="/test/listTest?courseId="+courseId;
                                            }
                                        </script>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div id="datatables-example_filter" class="dataTables_filter">
                                        <a class=" btn ripple-infinite btn-3d btn-primary" value="primary"
                                           style="margin-top: -10px;" href="${base}/test/addTestPage">
                                            <span><i class="fa fa-plus-square fa-lg"></i>&nbsp;&nbsp;添加试卷</span>
                                        </a>
                                    <#--<script>-->
                                    <#--addTest=function(){-->
                                    <#--$.ajax()-->
                                    <#--window.open("/admin/test/addtest");-->
                                    <#--}-->
                                    <#--</script>-->
                                    ...
                                    <#--</h4>-->
                                    <#--</div>-->
                                    <#--<form action="${base}/choice/addChoice?courseId=${(courseId)!}" method="post" enctype="multipart/form-data">-->
                                    ...
                                    <#--</select>-->
                                    <#--</div>-->
                                    <#--<label for="name" class="col-sm-3 control-label">选择题选取</label>-->
                                    <#--<div class="col-sm-9">-->
                                    <#--<select multiple="multiple" class="select">-->
                                    <#--<#list chiocequestionList as choice>-->
                                    <#--<option value ="${choice.id}">${choice.courseName}</option>-->
                                    <#--</#list>-->
                                    <#--<option>1</option>-->
                                    <#--<option>2</option>-->
                                    <#--<option>3</option>-->
                                    ...
                                    <#--<option>5</option>-->
                                    <#--</select>-->
                                    <#--&lt;#&ndash;<input type="text" style="width: 400px;" class="form-control" name="content"&ndash;&gt;-->
                                    <#--&lt;#&ndash;placeholder="请输入题目内容">&ndash;&gt;-->
                                    <#--</div>-->
                                    <#--<label for="name" class="col-sm-3 control-label">判断题选取</label>-->
                                    <#--<div class="col-sm-9">-->
                                    <#--<select multiple="multiple" class="select">-->
                                    <#--<option>1</option>-->
                                    <#--<option>2</option>-->
                                    ...
                                    <#--<option>5</option>-->
                                    <#--</select>-->
                                    <#--&lt;#&ndash;<input type="text" style="width: 400px;" class="form-control" name="answer"&ndash;&gt;-->
                                    <#--&lt;#&ndash;placeholder="请输入题目答案">&ndash;&gt;-->
                                    <#--</div>-->
                                    <#--</div>-->
                                        ...
                                        <table id="datatables-example"
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="datatables-example"
                                                    ...
                                                    aria-label="Office: activate to sort column ascending">选择题号
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="datatables-example"
                                                    rowspan="1" colspan="1" style="width: 125px;"
                                                    aria-label="Office: activate to sort column ascending">判断题号
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="datatables-example"
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="">
                                                ${question.choiceQuestionNum}
                                                </td>
                                                <td class="">
                                                ${question.tOrFQuestionNum}
                                                </td>
                                                <td>
                                                    <a href="${base}/test/deleteTest?id=${question.id}"
                                            ...
                                            <#--</h4>-->
                                            <#--</div>-->
                                            <#--<form action="${base}/choice/addChoice" method="post" enctype="multipart/form-data">-->
                                            ...
                                            <#--<div class="col-sm-9">-->
                                            <#--<input type="text" style="width: 400px;" class="form-control" name="op1"-->
                                            <#--value="${question.op1}" placeholder="请输入A">-->
                                            <#--</div>-->
                                            <#--<label for="name" class="col-sm-3 control-label">B:</label>-->
                                            <#--<div class="col-sm-9">-->
                                            <#--<input type="text" style="width: 400px;" class="form-control" name="op2"-->
                                            <#--value="${question.op2}" placeholder="请输入B">-->
                                            <#--</div>-->
                                            <#--<label for="name" class="col-sm-3 control-label">C:</label>-->
                                            <#--<div class="col-sm-9">-->
                                            <#--<input type="text" style="width: 400px;" class="form-control" name="op3"-->
                                            <#--value="${question.op3}" placeholder="请输入C">-->
                                            <#--</div>-->
                                            <#--<label for="name" class="col-sm-3 control-label">D:</label>-->
                                            <#--<div class="col-sm-9">-->
                                            <#--<input type="text" style="width: 400px;" class="form-control" name="op4"-->
                                            <#--value="${question.op4}" placeholder="请输入D">-->
                                            <#--</div>-->
                                            <#--</div>-->
                                            <#--<div class="modal-footer">-->
