    ...
    <div class="container-fluid">
        ...
        <div id="pad-wrapper">
            ...
            <div class="table-products section">
                ...
                <div>More Templates <a href="http://www.uimaker.com/" target="_blank" title="uimaker.com">uimaker.com</a> - Collect from <a href="http://www.uimaker.com/" title="后台模板" target="_blank">后台模板</a></div>
            </div>
            <!-- end table sample -->
        </div>
    </div>
