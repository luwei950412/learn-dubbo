        ...
        <div class="top-menu" style="margin-top: -10px;">
            <#--<div class="container">-->
                <#--<div class="row">-->
                    <#--<div class="col-xs-2">-->
                        <#--<div id="fh5co-logo">-->
                            <#--<a href="${base}/front/index.html">-->
                                <#--<img width="40px" height="40px" src="${base}/front/images/LOGOICON.png">-->
                                <#--<img width="80px" height="40px" style="margin-bottom:-15px;margin-top: -8px;" src="${base}/front/images/LOGO1.png">-->
                                <#--&lt;#&ndash;<i class="icon-study"></i>LEARN<span>.</span>&ndash;&gt;-->
                                <#--&lt;#&ndash;<i class="icon-study"></i>Hi 课<span>.</span>&ndash;&gt;-->
                            <#--</a>-->
                        <#--</div>-->
                    <#--</div>-->
                <#--&lt;#&ndash;发现的搜索框&ndash;&gt;-->
                    ...
                    <#--<form class="search_pos" name="sousuo" action="${base}/search/course">-->
                        <#--<div id="search">-->
                            ...
                            <#--&lt;#&ndash;<input class="button" type="submit" value="搜索">&ndash;&gt;-->
                    ...
                    <#--<div class="col-xs-10 text-right menu-1">-->
                        ...
                        <#--<ul>-->
                            ...
                            <#--<li><a href="${base}/user/frontLecture">讲师</a></li>-->
                            <#--<li><a href="${base}/qa/frontQa">问答</a></li>-->
                        ...
                        <div class="col-xs-2">
                            <div id="fh5co-logo">
                                <a href="${base}/front/index.html">
                                    <img width="40px" height="40px" src="${base}/front/images/LOGOICON.png">
                                    <img width="80px" height="40px" style="margin-bottom:-15px;margin-top: -8px;" src="${base}/front/images/LOGO1.png">
                                <#--<i class="icon-study"></i>LEARN<span>.</span>-->
                                <#--<i class="icon-study"></i>Hi 课<span>.</span>-->
                                </a>
                            </div>
                        </div>
                    <#--发现的搜索框-->
